...
int spin_lock_more_more_simple_bl_wfe2_nb(struct arg *argp)
{
	int ret;
	__asm__ __volatile__(
"1:	ldrex %0, [%1]\n"
...
int spin_lock_more_more_simple_bl_wfe2_isb(struct arg *argp)
{
	int ret;
	__asm__ __volatile__(
"1:	ldrex %0, [%1]\n"
...
int spin_lock_more_more_simple_bl_wfe2_dmb(struct arg *argp)
{
	int ret;
	__asm__ __volatile__(
"1:	ldrex %0, [%1]\n"
...
int unlock_with_nop_sev_dmb(struct arg *argp)
{
